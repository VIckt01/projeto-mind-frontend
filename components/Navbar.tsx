      ...
      {user ? (
        ...
        <div className="relative group flex items-center gap-2 py-2 cursor-pointer">
          ...
          <div className="absolute right-0 top-[45px] w-64 bg-[#14181F] border border-zinc-800/80 rounded-lg shadow-2xl p-4 flex flex-col invisible opacity-0 translate-y-1 group-hover:visible group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-200 z-50 text-left">
            ...
            {/* Link: Dashboard */}
            <a href="/dashboard" className="flex items-center gap-3 px-2 py-2.5 rounded text-zinc-300 hover:text-white hover:bg-zinc-800/40 transition-all text-xs">
            ...
            {/* Link: Configurações */}
            <a href="/configuracoes" className="flex items-center gap-3 px-2 py-2.5 rounded text-zinc-300 hover:text-white hover:bg-zinc-800/40 transition-all text-xs">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.8} stroke="currentColor" className="w-4 h-4 text-zinc-400">
            ...
            {/* Botão Ação: Sair */}
            <button onClick={logout} className="w-full flex items-center gap-3 px-2 py-2.5 rounded text-red-400 hover:bg-red-500/10 transition-all text-xs font-medium text-left cursor-pointer">
