...
export default function Cadastro() {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    // Validação local antes de disparar o fetch para a API
    ...
    try {
      ...
      // Redirecionamento após exibição da mensagem de sucesso
      setTimeout(() => {
        router.push("/login");
      }, 1500);
  ...
  return (
    <div className="w-full min-h-screen bg-[#0B0E13] text-white flex flex-col justify-between antialiased font-sans select-none">
      ...
      {/* DIV ARTIGO - CONTAINER CENTRAL RECUADO EM 360PX */}
      <main className="w-full max-w-[1440px] mx-auto xl:px-[360px] lg:px-[180px] md:px-[80px] px-4 py-16 flex flex-col items-center gap-10 flex-1 justify-center">
        ...
        {/* Cabeçalho Textual cópia fiel do Figma */}
      ...
      {/* FOOTER COMPONENTE - HUG 310PX, PT/PB 60PX, GAP 36PX */}
      <footer className="w-full border-t border-zinc-900/80 bg-[#0B0E13] py-[60px] px-10">
